...
void InstallPacketSink_ns3 (Ptr<Node> node, uint16_t port)
{
...
void InstallBulkSend_ns3 (Ptr<Node> node, Ipv4Address address, uint16_t port, 
...
//----------------------------------------------------------
  ...
  Config::SetDefault (queue_disc_type + "::MaxSize", QueueSizeValue (QueueSize ("100p"))); //changed from 666 to 100
...
// ------------------------------------------------------------
    ...
    InstallPacketSink_ns3 (rightNodes.Get (0), port);      // A Sink 0 Applications
    InstallPacketSink_ns3 (rightNodes.Get (1), port);      // B Sink 0 Applications
    InstallPacketSink_ns3 (rightNodes.Get (2), port);      // C Sink 0 Applications
    InstallPacketSink_ns3 (rightNodes.Get (3), port);      // D Sink 0 Applications
    InstallPacketSink_ns3 (rightNodes.Get (4), port);      // E Sink 0 Applications

    InstallBulkSend_ns3 (leftNodes.Get (0), routerToRightIPAddress [0].GetAddress (1), port, 2, 0, MakeCallback (&CwndChangeA));
    InstallBulkSend_ns3 (leftNodes.Get (1), routerToRightIPAddress [1].GetAddress (1), port, 3, 0, MakeCallback (&CwndChangeB));
    InstallBulkSend_ns3 (leftNodes.Get (2), routerToRightIPAddress [2].GetAddress (1), port, 4, 0, MakeCallback (&CwndChangeC));
    InstallBulkSend_ns3 (leftNodes.Get (3), routerToRightIPAddress [3].GetAddress (1), port, 5, 0, MakeCallback (&CwndChangeD));
    InstallBulkSend_ns3 (leftNodes.Get (4), routerToRightIPAddress [4].GetAddress (1), port, 6, 0, MakeCallback (&CwndChangeE));
